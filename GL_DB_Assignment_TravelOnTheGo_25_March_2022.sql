...
-- Solution 2 - If we consider exact bording and destination city in where clause as per question for pallavi.
...
where ps.Passenger_Name = 'Pallavi'
and ps.Destination_City  = 'Bengaluru' and  ps.Boarding_City = 'Panaji';
